...
(async () => {
  ...
  await wait(2000); // Wait for load and blurs
  ...
  await wait(3000); // wait for training curve convergence
  ...
  await wait(3000); // wait for pipeline steps
  ...
  await wait(2000); // Let some ticks render
